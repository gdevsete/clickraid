        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between h-16">
            ...
            <Link to="/" className="flex items-center">
              <img src={logoSrc} alt="ClickRaid" className="h-20 w-auto object-contain" />
            </Link>
            ...
            <div className="flex items-center gap-3">
              ...
              >
                ...
                {user && (
                  <span className="absolute -top-1 -right-1 w-2.5 h-2.5 bg-green-500 rounded-full border border-brand-black" />
                )}
              </Link>
        ...
        {mobileOpen && (
          <div className="md:hidden bg-brand-dark border-t border-brand-border animate-fade-in">
            <nav className="flex flex-col px-4 py-4 gap-4">
              ...
              <NavLinkItem to="/faq">FAQ</NavLinkItem>
              <NavLinkItem to={user ? '/minha-conta' : '/login'}>{user ? 'Minha Conta' : 'Entrar'}</NavLinkItem>
            </nav>
          </div>
        )}
      </header>
